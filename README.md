...
MultiVox is an open source softphone for voice and video over IP calling and instant messaging.
...
MultiVox is dual licensed, and is available either :
...
- MultiVox public wiki : https://wiki.linphone.org/xwiki/wiki/public/view/Linphone/
...
The first MultiVox-android release that will be based on this will be 4.5.0, using 5.0.0 SDK.
...
It will download the MultiVox library from our Maven repository as an AAR file so you don't have to build anything yourself.
